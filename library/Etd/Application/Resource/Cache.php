...
class Etd_Application_Resource_Cache extends Zend_Application_Resource_ResourceAbstract
{
  /**   
  ...
  public function getCache ()
  {
    if (null === $this->_cache) {
        ...
        if(false == $options['enable']){
            $options['frontend']['params']['caching'] = false;
            $options['backend']['params']['caching'] = false; 
        }
