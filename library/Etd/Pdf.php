...
class Etd_Pdf extends Zend_Pdf{
     ...
     */
    public static function drawTextBox(Zend_Pdf_Page $page, $text, $x1, $y1, $x2 = null, $position = self::TEXT_ALIGN_LEFT, $lineHeight = 1.1, $encoding = 'UTF-8'){
        if( $encoding == null ) $encoding = self::$encoding;
