...
$(document).ready(function() {
	...
	$("a.imglistbutton").tipsy ({ gravity: 'w' });
	
    
	// Load Facebox - simple add "rel="facebook" to any link to activate Modal Dialog
	$('a[rel*=facebox]').facebox({
        loadingImage : '/public/admin/images/loading.gif',
        closeImage   : '/public/admin/images/closelabel.png'
      })
    ...
    $(".date_picker").datepicker($.datepicker.regional['pl']);
    ...
    // CKFINDER
    $('input.ckfinder').ckFinderRow();
    
    $('input.ckfinderMovie').ckFinderMovieRow();
...
(function($){
	$.fn.ckFinderMovieRow = function(options) {
		var d = {
			basePath: '/public/scripts/ckfinder/',
		}; // default settings
...
(function($){
	$.fn.ckFinderRow = function(options) {
		var d = {
			basePath: '/public/scripts/ckfinder/',
		}; // default settings
...
function initFCK() {
    $('textarea.fck').each(function() {
        var FCKtxtarea = $(this).attr("id");
        FCKeditors[FCKtxtarea] = new FCKeditor(FCKtxtarea);
        FCKeditors[FCKtxtarea].BasePath = "public/scripts/fckeditor/";
        if($(this).height()){
            FCKeditors[FCKtxtarea].Height = $(this).height();
        }
        if($(this).hasClass('fckBasic')){
            FCKeditors[FCKtxtarea].ToolbarSet = 'Basic';
        }
        if($(this).hasClass('fckSimple')){
            FCKeditors[FCKtxtarea].ToolbarSet = 'Simple';
        }
        if($(this).hasClass('fckFull')){
            FCKeditors[FCKtxtarea].ToolbarSet = 'Full';
        }
        FCKeditors[FCKtxtarea].ReplaceTextarea();
    });
}
