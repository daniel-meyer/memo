		...
		$.post(form.attr('action'),form.serialize(),function(msg){
			...
			if(msg.success){
				...
				$.each(msg,function(k,v){
					...
					var errorIcon = $('<span>', {'id':'error_'+k}).addClass('errorIcon');
					var errorTip = $('<span>',{text:v}).addClass('errorTip').hide().appendTo(errorIcon);
		...
		return this.each(function(){
			...
			form.find('input[type=checkbox]').each(function(){
				...
				var originalCheckBox = $(this),
					checkBox = $('<span>').addClass('checkBox '+(this.checked?'checked':''));
			...
			form.find('input[type=radio]').each(function(){
				...
				var originalRadio = $(this),
					radio = $('<span>').addClass('radio '+(this.checked?'checked':''));
