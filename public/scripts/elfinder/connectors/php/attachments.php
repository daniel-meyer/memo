...
$opts = array(
	...
	'rootAlias'       => 'Dom',       // display this instead of root directory name
	//'uploadAllow'   => array('images/*'),
	'uploadDeny'    => array('all'),
	//'uploadOrder'   => 'deny,allow'
	'disabled'     => array('rename', 'edit', 'upload', 'mkdir', 'mkfile', 'resize', 'duplicate', 'read', 'paste', 'rm', 'archive', 'extract', 'ping'),      // list of not allowed commands
